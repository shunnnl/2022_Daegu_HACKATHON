...
class QRCheckScreen3 extends StatefulWidget {
  static const String ROUTE_NAME = '/qr_check_screen3';

  final String eventKeyword; //건져올 특정 키워드

  QRCheckScreen3({required this.eventKeyword});

  @override
  State<QRCheckScreen3> createState() => _QRCheckScreenState3();
}

class _QRCheckScreenState3 extends State<QRCheckScreen3> {
