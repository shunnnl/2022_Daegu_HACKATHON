...
class Veget2 extends StatefulWidget {
  const Veget2({Key? key}) : super(key: key);

  @override
  _Veget2 createState() => _Veget2();
}

class _Veget2 extends State<Veget2> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Chilseong Market Vegetarian'),
