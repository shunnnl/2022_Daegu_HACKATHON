...
import 'package:powerful_daegu/last3.dart';

class Apply3 extends StatefulWidget {
  const Apply3({Key? key}) : super(key: key);
  @override
  _Apply3 createState() => _Apply3();
}

class _Apply3 extends State<Apply3> {
    ...
    return Padding(
        ...
        child: MaterialButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const Last3()),
            );
          },
        ));
  }
