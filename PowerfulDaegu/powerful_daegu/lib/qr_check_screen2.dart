...
class QRCheckScreen2 extends StatefulWidget {
  static const String ROUTE_NAME = '/qr_check_screen2';

  final String eventKeyword; //건져올 특정 키워드

  QRCheckScreen2({required this.eventKeyword});

  @override
  State<QRCheckScreen2> createState() => _QRCheckScreenState2();
}

class _QRCheckScreenState2 extends State<QRCheckScreen2> {
